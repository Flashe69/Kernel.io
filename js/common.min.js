...
!function(e){function s(){e(window).scrollTop()>180?(h.addClass("fixed"),e(".fixed-menu").css("margin-top",60)):(h.removeClass("fixed"),e(".fixed-menu").css("margin-top",0))}function i(){e(window).scrollTop()>180&&(h.removeClass("fixed"),e(".fixed-menu").css("margin-top",0))}function n(){e(this).parent().siblings().find("ul").hide(),e(this).next().stop(!0).slideDown()}function t(){e(this).next("ul").is(":visible")?e(this).next("ul").stop(!0).slideUp():(e(this).parent().siblings().find("ul").stop(!0).slideUp(),e(this).next("ul").stop(!0).slideDown())}function o(){e(this).children("menu").children().find("ul").slideUp()}WebFont.load({google:{families:["El Messiri","Lato"]}}),e(".news-slide").slick({slideToScroll:!0,autoplay:!0,infinite:!0,mobileFirst:!0,swipe:!0}),e(".bestCow__slider").slick({slideToScroll:!0,autoplay:!1,infinite:!0,mobileFirst:!0,swipe:!0,adaptiveHeight:!0,dots:!1,arrows:!0,prevArrow:e(".prev"),nextArrow:e(".next"),responsive:[{breakpoint:1200,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0}},{breakpoint:992,settings:{slidesToShow:2,slidesToScroll:1,infinite:!0}},{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:1,infinite:!0}},{breakpoint:576,settings:{slidesToShow:1,slidesToScroll:1,infinite:!0}}]});var l=e(".header__logo a"),a=e(".logo-line");l.on("mouseenter",function(){e(this).find(a).css({width:"180px",transition:"all 0.8s ease"})}),l.on("mouseleave",function(){e(this).find(a).css({width:0,transition:"all 0.8s ease"})});var r=e(".right-box__picture"),c=e(".right-box__desc > .desc-border");r.on("mouseenter",function(){e(this).next().find(c).animate({width:"50%"},450)}),r.on("mouseleave",function(){e(this).next().find(c).animate({width:"0"},450)});var d=e(".next-read__link svg");d.on("mouseenter",function(){e(this).css({fill:"#000",transition:"all 0.8s ease"}),e(this).parent().prev().css({color:"#000",transition:"all 0.8s ease"})}),d.on("mouseleave",function(){e(this).css({fill:"#bababa",transition:"all 0.8s ease"}),e(this).parent().prev().css({color:"#bababa",transition:"all 0.8s ease"})});var u=e(".view-all__prev svg"),f=e(".view-all__next svg");u.on("mouseenter",function(){e(this).css({fill:"#000",transition:"all 0.8s ease"}),e(this).parent().next().css({color:"#000",transition:"all 0.8s ease"})}),u.on("mouseleave",function(){e(this).css({fill:"#bababa",transition:"all 0.8s ease"}),e(this).parent().next().css({color:"#bababa",transition:"all 0.8s ease"})}),f.on("mouseenter",function(){e(this).css({fill:"#000",transition:"all 0.8s ease"}),e(this).parent().prev().css({color:"#000",transition:"all 0.8s ease"})}),f.on("mouseleave",function(){e(this).css({fill:"#bababa",transition:"all 0.8s ease"}),e(this).parent().prev().css({color:"#bababa",transition:"all 0.8s ease"})}),f.on("mouseenter",function(){e(this).css({fill:"#000",transition:"all 0.8s ease"}),e(this).parent().next().css({color:"#000",transition:"all 0.8s ease"})}),f.on("mouseleave",function(){e(this).css({fill:"#bababa",transition:"all 0.8s ease"}),e(this).parent().next().css({color:"#bababa",transition:"all 0.8s ease"})}),e(".principle__envelope").children().next().on("click",function(s){s.preventDefault();var i=e(this);i.prev().toggleClass("details-info"),i.toggleClass("principle__envelope"),i.hasClass("principle__envelope")?i.text("стисліше"):i.text("детальніше")}),e(".input-phone").mask("(999)-99-999-99"),e(".run-string__content").hide(),e(".facts__envelope a").on("click",function(s){s.preventDefault(),e(this).parent().hide(),e(".run-string__content").show().marquee({duration:25e3,gap:0,delayBeforeStart:0,direction:"left",duplicated:!0,pauseOnHover:!1})});var p=e(".footer__wrap--item a");p.on("mouseenter",function(){e(this).prev().css({fill:"#f1c33c",transition:"all 0.8s ease"}).addClass("animated infinite pulse")}),p.on("mouseleave",function(){e(this).prev().css({fill:"#222222",transition:"all 0.8s ease"}).removeClass("animated infinite pulse")}),p.children("a").on("click",function(e){e.preventDefault()});var h=e(".header_menu_wrap");e(window).on("load resize",function(){e(window).width()<="991"?e(window).on("scroll",s):(e(window).on("scroll",i),h.removeClass("fixed"))}),e("#nav-icon2").on("click",function(){e(this).toggleClass("open"),e(".alt").toggleClass("flexed"),e(".submenuAlt").hide()}),e(window).on("load resize",function(){e(window).width()>="991"&&(e("#nav-icon2").removeClass("open"),e("menu").removeClass("flexed"))}),e(window).on("load resize",function(){e(window).outerWidth()<="991"?(e("menu").removeClass("menu").addClass("alt"),e(".submenu").removeClass("submenu").addClass("submenuAlt")):(e("menu").removeClass("alt").addClass("menu"),e(".submenuAlt").removeClass("submenuAlt").addClass("submenu"))}),e(window).on("load resize",function(){e(window).width()<="991"?e("menu li span, menu li a").off().on("click",t):(e("menu li span, menu li a").off().on("mouseenter",n),e(".header_menu").on("mouseleave",o))}),e(".lang a").on("click",function(s){s.preventDefault(),e(this).parent().children().removeClass("active"),e(this).addClass("active")}),e(".zoom").on("click",function(s){s.preventDefault(),e(this).hide().next().show(),e(this).parent().clone(!0).appendTo(".bestCow").removeClass("slick-slide slick-active slick-current").addClass("popup"),e(".bestCow__slider, .bestCow__heading, .bestCow__next-read, .bestCow__abzac").css({filter:"blur(2px)"})}),e(".zoomOut, .prev, .next").on("click",function(s){s.preventDefault(),e(".zoomOut").hide(),e(".zoom").show(),e(".bestCow__slider__item").removeClass("popup").addClass("slick-slide slick-active slick-current"),e(".bestCow__slider, .bestCow__heading, .bestCow__next-read, .bestCow__abzac").css({filter:"blur(0)"})}),e(".filter_sort").children().on("click",function(s){s.preventDefault(),e(this).addClass("active"),e(this).siblings().removeClass("active")});var m=e(".prev_button");m.on("click",function(s){s.preventDefault(),e(".hide").slideToggle(800),e(this).toggleClass("rotate")}),m.on("mouseenter",function(){e(this).siblings().css({color:"#222",transition:"all 0.8s ease"})}),m.on("mouseleave",function(){e(this).siblings().css({color:"#8c8c8c",transition:"all 0.8s ease"})})}(jQuery);