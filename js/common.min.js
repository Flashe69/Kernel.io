...
!function(t){function e(o){if(i[o])return i[o].exports;var r=i[o]={i:o,l:!1,exports:{}};return t[o].call(r.exports,r,r.exports,e),r.l=!0,r.exports}var i={};e.m=t,e.c=i,e.i=function(t){return t},e.d=function(t,i,o){e.o(t,i)||Object.defineProperty(t,i,{configurable:!1,enumerable:!0,get:o})},e.n=function(t){var i=t&&t.__esModule?function(){return t.default}:function(){return t};return e.d(i,"a",i),i},e.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},e.p="",e(e.s=5)}([function(t,e,i){"use strict";function o(t,e){for(var i in t)t.hasOwnProperty(i)&&e(i,t[i])}var r=!1;try{var n=Object.defineProperty({},"passive",{get:function(){r=!0}});window.addEventListener("test",null,n)}catch(t){}t.exports.event=function(t,e,i,o){var n=e.split(" "),s="on"==o?"add":"remove";n.forEach(function(e){var o=!1;-1!=["scroll","touchstart","touchmove"].indexOf(e)&&r&&(o={passive:!0}),t[s+"EventListener"](e,i,o)})},t.exports.css=function(t,e,i){var r;if(void 0===i){if("string"==typeof e)return t.style[e];r=e}else(r={})[e]=i;o(r,function(e,i){t.style[e]=i})},t.exports.add=function(t,e){e&&t.classList.add(e)},t.exports.rm=function(t,e){e&&t.classList.remove(e)},t.exports.has=function(t,e){return!!e&&t.classList.contains(e)},t.exports.clone=function(t){var e={};return o(t||{},function(t,i){e[t]=i}),e},t.exports.qs=function(t,e){return t instanceof HTMLElement?t:(e||document).querySelector(t)},t.exports.each=o},function(t,e){function i(){throw new Error("setTimeout has not been defined")}function o(){throw new Error("clearTimeout has not been defined")}function r(t){if(u===setTimeout)return setTimeout(t,0);if((u===i||!u)&&setTimeout)return u=setTimeout,setTimeout(t,0);try{return u(t,0)}catch(e){try{return u.call(null,t,0)}catch(e){return u.call(this,t,0)}}}function n(t){if(h===clearTimeout)return clearTimeout(t);if((h===o||!h)&&clearTimeout)return h=clearTimeout,clearTimeout(t);try{return h(t)}catch(e){try{return h.call(null,t)}catch(e){return h.call(this,t)}}}function s(){v&&f&&(v=!1,f.length?d=f.concat(d):g=-1,d.length&&l())}function l(){if(!v){var t=r(s);v=!0;for(var e=d.length;e;){for(f=d,d=[];++g<e;)f&&f[g].run();g=-1,e=d.length}f=null,v=!1,n(t)}}function c(t,e){this.fun=t,this.array=e}function a(){}var u,h,p=t.exports={};!function(){try{u="function"==typeof setTimeout?setTimeout:i}catch(t){u=i}try{h="function"==typeof clearTimeout?clearTimeout:o}catch(t){h=o}}();var f,d=[],v=!1,g=-1;p.nextTick=function(t){var e=new Array(arguments.length-1);if(arguments.length>1)for(var i=1;i<arguments.length;i++)e[i-1]=arguments[i];d.push(new c(t,e)),1!==d.length||v||r(l)},c.prototype.run=function(){this.fun.apply(null,this.array)},p.title="browser",p.browser=!0,p.env={},p.argv=[],p.version="",p.versions={},p.on=a,p.addListener=a,p.once=a,p.off=a,p.removeListener=a,p.removeAllListeners=a,p.emit=a,p.prependListener=a,p.prependOnceListener=a,p.listeners=function(t){return[]},p.binding=function(t){throw new Error("process.binding is not supported")},p.cwd=function(){return"/"},p.chdir=function(t){throw new Error("process.chdir is not supported")},p.umask=function(){return 0}},function(t,e){t.exports=function(t,e,i){var o=console[t]||console.log,r=["Baron: "+e,i];Function.prototype.apply.call(o,console,r)}},function(t,e,i){"use strict";(function(e){function o(t){var i,o,r=!!t,n=(t&&t[0]||t)instanceof HTMLElement?{root:t}:y(t),s={direction:"v",barOnCls:"_scrollbar",resizeDebounce:0,event:d,cssGuru:!1,impact:"scroller",position:"static"};n=n||{};for(var a in s)null==n[a]&&(n[a]=s[a]);if("production"!==e.env.NODE_ENV&&"absolute"==n.position&&"clipper"==n.impact&&u("error",["Simultaneous use of `absolute` position and `clipper` impact values detected.","Those values cannot be used together.","See more https://github.com/Diokuz/baron/issues/138"].join(" "),n),i=this&&this instanceof f.jQuery,n._chain?o=n.root:i?n.root=o=this[0]:o=w(n.root||n.scroller),"production"===e.env.NODE_ENV||o){var h=l(o,n.direction),p=+h;if(n.index=p,p==p&&null!==h&&z[p])return"production"!==e.env.NODE_ENV&&r&&u("error",["repeated initialization for html-node detected","https://github.com/Diokuz/baron/blob/master/docs/logs/repeated.md"].join(", "),n.root),z[p];n.root&&n.scroller?(n.scroller=w(n.scroller,o),"production"!==e.env.NODE_ENV&&(n.scroller||u("error","Scroller not found!",o,n.scroller))):n.scroller=o,n.root=o;var v=c(n);return v.autoUpdate&&v.autoUpdate(),v}u("error",["Barin initialization failed: root node not found."].join(", "),n)}function r(t,e){var i=0,o=t;for(void 0!==o.length&&o!==f||(o=[o]);o[i];)e.call(this,o[i],i),i++}function n(){return(new Date).getTime()}function s(t,e,i){t._eventHandlers=t._eventHandlers||[{element:t.scroller,handler:function(e){t.scroll(e)},type:"scroll"},{element:t.root,handler:function(){t.update()},type:"transitionend animationend"},{element:t.scroller,handler:function(){t.update()},type:"keyup"},{element:t.bar,handler:function(e){e.preventDefault(),t.selection(),t.drag.now=1,t.draggingCls&&g(t.root,t.draggingCls)},type:"touchstart mousedown"},{element:document,handler:function(){t.selection(1),t.drag.now=0,t.draggingCls&&b(t.root,t.draggingCls)},type:"mouseup blur touchend"},{element:document,handler:function(e){2!=e.button&&t._pos0(e)},type:"touchstart mousedown"},{element:document,handler:function(e){t.drag.now&&t.drag(e)},type:"mousemove touchmove"},{element:f,handler:function(){t.update()},type:"resize"},{element:t.root,handler:function(){t.update()},type:"sizeChange"},{element:t.clipper,handler:function(){t.clipperOnScroll()},type:"scroll"}],r(t._eventHandlers,function(t){if(t.element)if(t.element.length)for(var o=0;o<t.element.length;o++)e(t.element[o],t.type,t.handler,i);else e(t.element,t.type,t.handler,i)})}function l(t,e,i,o){var r="data-baron-"+e+"-id";return"on"==i?t.setAttribute(r,o):"off"==i&&t.removeAttribute(r),t.getAttribute(r)}function c(t){var i=new o.prototype.constructor(t);return s(i,t.event,"on"),l(i.root,t.direction,"on",z.length),z.push(i),"production"!==e.env.NODE_ENV&&(++h>100&&!p.liveTooMany&&(u("warn",["You have too many live baron instances on page ("+h+")!","Are you forget to dispose some of them?","All baron instances can be found in baron._instances:"].join(" "),z),p.liveTooMany=!0),z.length>1e3&&!p.allTooMany&&(u("warn",["You have too many inited baron instances on page ("+z.length+")!","Some of them are disposed, and thats good news.","but baron.init was call too many times, and thats is bad news.","All baron instances can be found in baron._instances:"].join(" "),z),p.allTooMany=!0)),i.update(),i}function a(t){if(this.events&&this.events[t])for(var e=0;e<this.events[t].length;e++){var i=Array.prototype.slice.call(arguments,1);this.events[t][e].apply(this,i)}}var u,h,p,f=function(){return this||(0,eval)("this")}(),d=i(0).event,v=i(0).css,g=i(0).add,m=i(0).has,b=i(0).rm,y=i(0).clone,w=i(0).qs,x=o,T=["left","top","right","bottom","width","height"],z=[],_={v:{x:"Y",pos:T[1],oppos:T[3],crossPos:T[0],crossOpPos:T[2],size:T[5],crossSize:T[4],crossMinSize:"min-"+T[4],crossMaxSize:"max-"+T[4],client:"clientHeight",crossClient:"clientWidth",scrollEdge:"scrollLeft",offset:"offsetHeight",crossOffset:"offsetWidth",offsetPos:"offsetTop",scroll:"scrollTop",scrollSize:"scrollHeight"},h:{x:"X",pos:T[0],oppos:T[2],crossPos:T[1],crossOpPos:T[3],size:T[4],crossSize:T[5],crossMinSize:"min-"+T[5],crossMaxSize:"max-"+T[5],client:"clientWidth",crossClient:"clientHeight",scrollEdge:"scrollTop",offset:"offsetWidth",crossOffset:"offsetHeight",offsetPos:"offsetLeft",scroll:"scrollLeft",scrollSize:"scrollWidth"}},E=17,O=15,S=/[\s\S]*Macintosh[\s\S]*\) Gecko[\s\S]*/.test(f.navigator&&f.navigator.userAgent);"production"!==e.env.NODE_ENV&&(u=i(2),h=0,p={liveTooMany:!1,allTooMany:!1}),"production"!==e.env.NODE_ENV&&(o._instances=z),o.prototype={_debounce:function(t,e){var i,o,r=this,s=function(){if(r._disposed)return clearTimeout(i),void(i=r=null);var l=n()-o;l<e&&l>=0?i=setTimeout(s,e-l):(i=null,t())};return function(){o=n(),i||(i=setTimeout(s,e))}},constructor:function(t){function i(t){var e=this.barMinSize||20,i=t;i>0&&i<e&&(i=e),this.bar&&v(this.bar,this.origin.size,parseInt(i,10)+"px")}function o(t){if(this.bar){var e=v(this.bar,this.origin.pos),i=+t+"px";i&&i!=e&&v(this.bar,this.origin.pos,i)}}function r(){return d[this.origin.client]-this.barTopLimit-this.bar[this.origin.offset]}function s(t){return t*r.call(this)+this.barTopLimit}function l(t){return(t-this.barTopLimit)/r.call(this)}function c(){return!1}var h,p,d,y,x,T,z;if(T=n(),this.params=t,this.event=t.event,this.events={},this.root=t.root,this.scroller=w(t.scroller),"production"!==e.env.NODE_ENV&&"body"==this.scroller.tagName&&u("error",["Please, do not use BODY as a scroller.","https://github.com/Diokuz/baron/blob/master/docs/logs/do-not-use-body.md"].join(", "),t),this.bar=w(t.bar,this.root),d=this.track=w(t.track,this.root),!this.track&&this.bar&&(d=this.bar.parentNode),this.clipper=this.scroller.parentNode,this.direction=t.direction,this.rtl=t.rtl,this.origin=_[this.direction],this.barOnCls=t.barOnCls,this.scrollingCls=t.scrollingCls,this.draggingCls=t.draggingCls,this.impact=t.impact,this.position=t.position,this.rtl=t.rtl,this.barTopLimit=0,this.resizeDebounce=t.resizeDebounce,this.cursor=function(t){return t["client"+this.origin.x]||(((t.originalEvent||t).touches||{})[0]||{})["page"+this.origin.x]},this.pos=function(t){var e="page"+this.origin.x+"Offset",i=this.scroller[e]?e:this.origin.scroll;return void 0!==t&&(this.scroller[i]=t),this.scroller[i]},this.rpos=function(t){var e=this.scroller[this.origin.scrollSize]-this.scroller[this.origin.client];return(t?this.pos(t*e):this.pos())/(e||1)},this.barOn=function(t){if(this.barOnCls){var e=this.scroller[this.origin.client]>=this.scroller[this.origin.scrollSize];t||e?m(this.root,this.barOnCls)&&b(this.root,this.barOnCls):m(this.root,this.barOnCls)||g(this.root,this.barOnCls)}},this._pos0=function(t){p=this.cursor(t)-h},this.drag=function(t){var e=l.call(this,this.cursor(t)-p),i=this.scroller[this.origin.scrollSize]-this.scroller[this.origin.client];this.scroller[this.origin.scroll]=e*i},this.selection=function(t){this.event(document,"selectpos selectstart",c,t?"off":"on")},this.resize=function(){function t(){var t,i=e.scroller[e.origin.crossOffset],o=e.scroller[e.origin.crossClient],r=0;if(S?r=O:o>0&&0===i&&(i=o+E),i)if(e.barOn(),"scroller"==e.impact){var s=i-o+r;if("static"==e.position)v(e.scroller,e.origin.crossSize)!=(t=e.clipper[e.origin.crossClient]+s+"px")&&e._setCrossSizes(e.scroller,t);else{var l={},c=e.rtl?"Left":"Right";"h"==e.direction&&(c="Bottom"),l["padding"+c]=s+"px",v(e.scroller,l)}}else v(e.clipper,e.origin.crossSize)!=(t=o+"px")&&e._setCrossSizes(e.clipper,t);Array.prototype.unshift.call(arguments,"resize"),a.apply(e,arguments),T=n()}var e=this,i=void 0===e.resizeDebounce?300:e.resizeDebounce,o=0;n()-T<i&&(clearTimeout(y),o=i),o?y=setTimeout(t,o):t()},this.updatePositions=function(t){var e,r=this;r.bar&&(e=(d[r.origin.client]-r.barTopLimit)*r.scroller[r.origin.client]/r.scroller[r.origin.scrollSize],(t||parseInt(z,10)!=parseInt(e,10))&&(i.call(r,e),z=e),h=s.call(r,r.rpos()),o.call(r,h)),Array.prototype.unshift.call(arguments,"scroll"),a.apply(r,arguments)},this.scroll=function(){var t=this;t.updatePositions(),t.scrollingCls&&(x||g(t.root,t.scrollingCls),clearTimeout(x),x=setTimeout(function(){b(t.root,t.scrollingCls),x=void 0},300))},this.clipperOnScroll=function(){this.rtl?this.clipper[this.origin.scrollEdge]=this.clipper[this.origin.scrollSize]:this.clipper[this.origin.scrollEdge]=0},this._setCrossSizes=function(t,e){var i={};i[this.origin.crossSize]=e,i[this.origin.crossMinSize]=e,i[this.origin.crossMaxSize]=e,v(t,i)},this._dumbCss=function(e){if(!t.cssGuru){var i=e?"hidden":null,o=e?"none":null;v(this.clipper,{overflow:i,msOverflowStyle:o,position:"static"==this.position?"":"relative"});var r=e?"scroll":null,n={};n["overflow-"+("v"==this.direction?"y":"x")]=r,n["box-sizing"]="border-box",n.margin="0",n.border="0","absolute"==this.position&&(n.position="absolute",n.top="0","h"==this.direction?n.left=n.right="0":(n.bottom="0",n.right=this.rtl?"0":"",n.left=this.rtl?"":"0")),v(this.scroller,n)}},this._dumbCss(!0),S){var C="paddingRight",N={},D=f.getComputedStyle(this.scroller)[[C]];"h"==t.direction?C="paddingBottom":t.rtl&&(C="paddingLeft");var L=parseInt(D,10);L!=L&&(L=0),N[C]=O+L+"px",v(this.scroller,N)}return this},update:function(t){return"production"!==e.env.NODE_ENV&&this._disposed&&u("error",["Update on disposed baron instance detected.","You should clear your stored baron value for this instance:",this].join(" "),t),a.call(this,"upd",t),this.resize(1),this.updatePositions(1),this},dispose:function(){"production"!==e.env.NODE_ENV&&(this._disposed&&u("error","Already disposed:",this),h--),s(this,this.event,"off"),l(this.root,this.params.direction,"off"),"v"==this.params.direction?this._setCrossSizes(this.scroller,""):this._setCrossSizes(this.clipper,""),this._dumbCss(!1),this.barOn(!0),a.call(this,"dispose"),z[this.params.index]=null,this.params=null,this._disposed=!0},on:function(t,e,i){for(var o=t.split(" "),r=0;r<o.length;r++)"init"==o[r]?e.call(this,i):(this.events[o[r]]=this.events[o[r]]||[],this.events[o[r]].push(function(t){e.call(this,t||i)}))},baron:function(t){return t.root=this.params.root,t.scroller=this.params.scroller,t.direction="v"==this.params.direction?"h":"v",t._chain=!0,o(t)}},o.prototype.constructor.prototype=o.prototype,o.noConflict=function(){return f.baron=x,o},o.version="3.0.0",o.prototype.autoUpdate=i(4)(f),o.prototype.fix=i(7),o.prototype.controls=i(6),t.exports=o}).call(e,i(1))},function(t,e,i){"use strict";function o(t){function e(){n.root[n.origin.offset]?o():i()}function i(){r||(r=setInterval(function(){n.root[n.origin.offset]&&(o(),n.update())},300))}function o(){clearInterval(r),r=null}var r,n=this;if(!this._au){var s=n._debounce(function(){n.update()},300);this._observer=new t(function(){e(),n.update(),s()}),this.on("init",function(){n._observer.observe(n.root,{childList:!0,subtree:!0,characterData:!0}),e()}),this.on("dispose",function(){n._observer.disconnect(),o(),delete n._observer}),this._au=!0}}t.exports=function(t){var e=t.MutationObserver||t.WebKitMutationObserver||t.MozMutationObserver||null;return function(){return e?(o.call(this,e),this):this}}},function(t,e,i){var o=i(3);window.baron=o,window.jQuery&&window.jQuery.fn&&(window.jQuery.fn.baron=o)},function(t,e,i){"use strict";var o=i(0).qs;t.exports=function(t){var e,i,r,n=this;i=t.screen||.9,t.forward&&(r={element:o(t.forward,this.clipper),handler:function(){var e=n.pos()+(t.delta||30);n.pos(e)},type:"click"},this._eventHandlers.push(r),this.event(r.element,r.type,r.handler,"on")),t.backward&&(r={element:o(t.backward,this.clipper),handler:function(){var e=n.pos()-(t.delta||30);n.pos(e)},type:"click"},this._eventHandlers.push(r),this.event(r.element,r.type,r.handler,"on")),t.track&&(e=!0===t.track?this.track:o(t.track,this.clipper))&&(r={element:e,handler:function(t){if(t.target==e){var o=t["offset"+n.origin.x],r=n.bar[n.origin.offsetPos],s=0;o<r?s=-1:o>r+n.bar[n.origin.offset]&&(s=1);var l=n.pos()+s*i*n.scroller[n.origin.client];n.pos(l)}},type:"mousedown"},this._eventHandlers.push(r),this.event(r.element,r.type,r.handler,"on"))}},function(t,e,i){"use strict";(function(e){var o=i(2),r=i(0).css,n=i(0).add,s=i(0).rm;t.exports=function(t){function i(t,e,i){var o=e,l=1==i?"pos":"oppos";u<(h.minView||0)&&(o=void 0),r(a[t],this.origin.pos,""),r(a[t],this.origin.oppos,""),s(a[t],h.outside),void 0!==o&&(o+="px",r(a[t],this.origin[l],o),n(a[t],h.outside))}function l(t){try{var e=document.createEvent("WheelEvent");e.initWebKitWheelEvent(t.originalEvent.wheelDeltaX,t.originalEvent.wheelDeltaY),v.dispatchEvent(e),t.preventDefault()}catch(t){}}function c(t){var e;for(var i in t)h[i]=t[i];if(h.elements instanceof HTMLElement?a=[h.elements]:"string"==typeof h.elements?a=this.scroller.querySelectorAll(h.elements):h.elements&&h.elements[0]instanceof HTMLElement&&(a=h.elements),a){u=this.scroller[this.origin.client];for(var o=0;o<a.length;o++)(e={})[this.origin.size]=a[o][this.origin.offset]+"px",a[o].parentNode!==this.scroller&&r(a[o].parentNode,e),(e={})[this.origin.crossSize]=a[o].parentNode[this.origin.crossClient]+"px",r(a[o],e),u-=a[o][this.origin.offset],d[o]=a[o].parentNode[this.origin.offsetPos],p[o]=p[o-1]||0,f[o]=f[o-1]||Math.min(d[o],0),a[o-1]&&(p[o]+=a[o-1][this.origin.offset],f[o]+=a[o-1][this.origin.offset]),0==o&&0==d[o]||(this.event(a[o],"mousewheel",l,"off"),this.event(a[o],"mousewheel",l));h.limiter&&a[0]&&(this.track&&this.track!=this.scroller?((e={})[this.origin.pos]=a[0].parentNode[this.origin.offset]+"px",r(this.track,e)):this.barTopLimit=a[0].parentNode[this.origin.offset],this.scroll()),!1===h.limiter&&(this.barTopLimit=0)}var n={element:a,handler:function(){for(var t,e=this.parentNode.offsetTop,i=0;i<a.length;i++)a[i]===this&&(t=i);var o=e-p[t];h.scroll?h.scroll({x1:m.scroller.scrollTop,x2:o}):m.scroller.scrollTop=o},type:"click"};if(h.clickable){this._eventHandlers.push(n);for(var s=0;s<n.element.length;s++)g(n.element[s],n.type,n.handler,"on")}}var a,u,h={outside:"",inside:"",before:"",after:"",past:"",future:"",radius:0,minView:0},p=[],f=[],d=[],v=this.scroller,g=this.event,m=this;"production"!==e.env.NODE_ENV&&"static"!=this.position&&o("error",["Fix plugin cannot work properly in non-static baron position.","See more https://github.com/Diokuz/baron/issues/135"].join(" "),this.params),this.on("init",c,t);var b=[],y=[];return this.on("init scroll",function(){var t,e,o,r;if(a){var l;for(r=0;r<a.length;r++)t=0,d[r]-this.pos()<f[r]+h.radius?(t=1,e=p[r]):d[r]-this.pos()>f[r]+u-h.radius?(t=2,e=this.scroller[this.origin.client]-a[r][this.origin.offset]-p[r]-u):(t=3,e=void 0),o=!1,(d[r]-this.pos()<f[r]||d[r]-this.pos()>f[r]+u)&&(o=!0),t==b[r]&&o==y[r]||(i.call(this,r,e,t),b[r]=t,y[r]=o,l=!0);if(l)for(r=0;r<a.length;r++)1==b[r]&&h.past&&(n(a[r],h.past),s(a[r],h.future)),2==b[r]&&h.future&&(n(a[r],h.future),s(a[r],h.past)),3==b[r]&&(s(a[r],h.past),s(a[r],h.future),n(a[r],h.inside)),b[r]!=b[r+1]&&1==b[r]?(n(a[r],h.before),s(a[r],h.after)):b[r]!=b[r-1]&&2==b[r]?(n(a[r],h.after),s(a[r],h.before)):(s(a[r],h.before),s(a[r],h.after)),h.grad&&(y[r]?n(a[r],h.grad):s(a[r],h.grad))}}),this.on("resize upd",function(t){c.call(this,t&&t.fix)}),this}}).call(e,i(1))}]);
!function(e){function s(){e(window).scrollTop()>180?(h.addClass("fixed"),e(".fixed-menu").css("margin-top",60)):(h.removeClass("fixed"),e(".fixed-menu").css("margin-top",0))}function i(){e(window).scrollTop()>180&&(h.removeClass("fixed"),e(".fixed-menu").css("margin-top",0))}function n(){e(this).parent().siblings().find("ul").hide(),e(this).next().stop(!0).slideDown()}function t(){e(this).next("ul").is(":visible")?e(this).next("ul").stop(!0).slideUp():(e(this).parent().siblings().find("ul").stop(!0).slideUp(),e(this).next("ul").stop(!0).slideDown())}function o(){e(this).children("menu").children().find("ul").slideUp()}baron({root:".site",scrollingCls:"_scrolling",draggingCls:"_dragging",direction:"h",impact:"scroller"}),WebFont.load({google:{families:["El Messiri","Lato"]}}),e(".news-slide").slick({slideToScroll:!0,autoplay:!0,infinite:!0,mobileFirst:!0,swipe:!0}),e(".bestCow__slider").slick({slideToScroll:!0,autoplay:!1,infinite:!0,mobileFirst:!0,swipe:!0,adaptiveHeight:!0,dots:!1,arrows:!0,prevArrow:e(".prev"),nextArrow:e(".next"),responsive:[{breakpoint:1200,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0}},{breakpoint:992,settings:{slidesToShow:2,slidesToScroll:1,infinite:!0}},{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:1,infinite:!0}},{breakpoint:576,settings:{slidesToShow:1,slidesToScroll:1,infinite:!0}}]});var l=e(".header__logo a"),a=e(".logo-line");l.on("mouseenter",function(){e(this).find(a).css({width:"180px",transition:"all 0.8s ease"})}),l.on("mouseleave",function(){e(this).find(a).css({width:0,transition:"all 0.8s ease"})});var r=e(".right-box__picture"),c=e(".right-box__desc > .desc-border");r.on("mouseenter",function(){e(this).next().find(c).animate({width:"50%"},450)}),r.on("mouseleave",function(){e(this).next().find(c).animate({width:"0"},450)});var d=e(".next-read__link svg");d.on("mouseenter",function(){e(this).css({fill:"#000",transition:"all 0.8s ease"}),e(this).parent().prev().css({color:"#000",transition:"all 0.8s ease"})}),d.on("mouseleave",function(){e(this).css({fill:"#bababa",transition:"all 0.8s ease"}),e(this).parent().prev().css({color:"#bababa",transition:"all 0.8s ease"})});var u=e(".view-all__prev svg"),p=e(".view-all__next svg");u.on("mouseenter",function(){e(this).css({fill:"#000",transition:"all 0.8s ease"}),e(this).parent().next().css({color:"#000",transition:"all 0.8s ease"})}),u.on("mouseleave",function(){e(this).css({fill:"#bababa",transition:"all 0.8s ease"}),e(this).parent().next().css({color:"#bababa",transition:"all 0.8s ease"})}),p.on("mouseenter",function(){e(this).css({fill:"#000",transition:"all 0.8s ease"}),e(this).parent().prev().css({color:"#000",transition:"all 0.8s ease"})}),p.on("mouseleave",function(){e(this).css({fill:"#bababa",transition:"all 0.8s ease"}),e(this).parent().prev().css({color:"#bababa",transition:"all 0.8s ease"})}),e(".principle__envelope").children().next().on("click",function(s){s.preventDefault();var i=e(this);i.prev().toggleClass("details-info"),i.toggleClass("principle__envelope"),i.hasClass("principle__envelope")?i.text("стисліше"):i.text("детальніше")}),e(".input-phone").mask("(999)-99-999-99"),e(".run-string__content").hide(),e(".facts__envelope a").on("click",function(s){s.preventDefault(),e(this).parent().hide(),e(".run-string__content").show().marquee({duration:25e3,gap:0,delayBeforeStart:0,direction:"left",duplicated:!0,pauseOnHover:!1})});var f=e(".footer__wrap--item a");f.on("mouseenter",function(){e(this).prev().css({fill:"#f1c33c",transition:"all 0.8s ease"}).addClass("animated infinite pulse")}),f.on("mouseleave",function(){e(this).prev().css({fill:"#222222",transition:"all 0.8s ease"}).removeClass("animated infinite pulse")}),f.children("a").on("click",function(e){e.preventDefault()});var h=e(".header_menu_wrap");e(window).on("load resize",function(){e(window).width()<="991"?e(window).on("scroll",s):(e(window).on("scroll",i),h.removeClass("fixed"))}),e("#nav-icon2").on("click",function(){e(this).toggleClass("open"),e(".alt").toggleClass("flexed"),e(".submenuAlt").hide()}),e(window).on("load resize",function(){e(window).width()>="991"&&(e("#nav-icon2").removeClass("open"),e("menu").removeClass("flexed"))}),e(window).on("load resize",function(){e(window).width()<="991"?(e("menu").removeClass("menu").addClass("alt"),e(".submenu").removeClass("submenu").addClass("submenuAlt")):(e("menu").removeClass("alt").addClass("menu"),e(".submenuAlt").removeClass("submenuAlt").addClass("submenu"))}),e(window).on("load resize",function(){e(window).width()<="991"?e("menu li span, menu li a").off().on("click",t):(e("menu li span, menu li a").off().on("mouseenter",n),e(".header_menu").on("mouseleave",o))}),e(".lang a").on("click",function(s){s.preventDefault(),e(this).parent().children().removeClass("active"),e(this).addClass("active")}),e(".zoom").on("click",function(s){s.preventDefault(),e(this).hide().next().show(),e(this).parent().clone(!0).appendTo(".bestCow").removeClass("slick-slide slick-active slick-current").addClass("popup"),e(".bestCow__slider, .bestCow__heading, .bestCow__next-read, .bestCow__abzac").css({filter:"blur(2px)"})}),e(".zoomOut, .prev, .next").on("click",function(s){s.preventDefault(),e(".zoomOut").hide(),e(".zoom").show(),e(".bestCow__slider__item").removeClass("popup").addClass("slick-slide slick-active slick-current"),e(".bestCow__slider, .bestCow__heading, .bestCow__next-read, .bestCow__abzac").css({filter:"blur(0)"})}),e(".filter_sort").children().on("click",function(s){s.preventDefault(),e(this).addClass("active"),e(this).siblings().removeClass("active")});var m=e(".prev_button");m.on("click",function(s){s.preventDefault(),e(".hide").slideToggle(800),e(this).toggleClass("rotate")}),m.on("mouseenter",function(){e(this).siblings().css({color:"#222",transition:"all 0.8s ease"})}),m.on("mouseleave",function(){e(this).siblings().css({color:"#8c8c8c",transition:"all 0.8s ease"})})}(jQuery);